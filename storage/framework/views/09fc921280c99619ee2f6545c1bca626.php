                                    ...
                                    <div class="col-xl-4 col-lg-10">
                                        <div class="row g-2">
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" class="image-popup d-block">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" class="img-fluid d-block rounded" />
                                                    </a>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" class="image-popup d-block">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" class="img-fluid d-block rounded" />
                                                    </a>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" class="image-popup d-block">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" class="img-fluid d-block rounded" />
                                                    </a>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-3 col-sm-6">
                                                <div class="search-more-results rounded">
                                                    <a href="javascript:void(0);" onclick="myFunction()" class="d-block">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" class="img-fluid d-block rounded" />
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" alt="" width="65" class="rounded" />
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-11.jpg')); ?>" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-10.jpg')); ?>" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                            ...
                            <div class="gallery-light">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                                        <h5 class="overlay-caption">Glasses and laptop from above</h5>
                                                    </div>
                                                </a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-11.jpg')); ?>" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" title="">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" width="115" class="rounded-1" />
                                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span class="badge bg-success-subtle text-success fs-11">Business</span></li>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span class="badge bg-danger-subtle text-danger fs-11">Design</span></li>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span class="badge bg-warning-subtle text-warning fs-11">Development</span></li>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/search-result.init.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\default\resources\views/pages-search-results.blade.php ENDPATH**/ ?>