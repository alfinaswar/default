                              ...
                              <div class="col-12">
                                  <div class="timeline-box">
                                      <div class="timeline-text">
                                          ...
                                          <div class="row border border-dashed rounded gx-2 p-2">
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('build/images/small/img-10.jpg')); ?>" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                          </div>
                                      </div>
                                  </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\default\resources\views/pages-timeline.blade.php ENDPATH**/ ?>