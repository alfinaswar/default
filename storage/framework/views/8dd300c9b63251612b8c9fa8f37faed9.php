                ...
                <div>
                    ...
                    <div class="github-style d-flex align-items-center my-2">
                        <div class="flex-shrink-0 me-2">
                            <img class="avatar-sm rounded" src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" data-hovercard-user-id="634573" alt="" />
                        </div>
...
<script src="<?php echo e(URL::asset('build/js/pages/apexcharts-area.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\default\resources\views/charts-apex-area.blade.php ENDPATH**/ ?>