                        ...
                        <div class="card-header border-bottom-dashed p-4">
                                ...
                                <div class="alert alert-danger">
                                    <p class="mb-0"><span class="fw-semibold">NOTES:</span>
                                        <span id="note">Kami mohon agar Anda melakukan transfer sebelum 24 jam dari
                                            dibuatnya invoice untuk menghindari kegagalan secara otomatis. Terima kasih atas
                                            kerjasama dan pengertian Anda.
                                        </span>
                                    </p>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\default\resources\views/apps-invoices-details.blade.php ENDPATH**/ ?>