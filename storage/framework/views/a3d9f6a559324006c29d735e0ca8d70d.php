...
<div class="app-menu navbar-menu">
 ...
 <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('list-program')); ?>">
                        <i class="ri-honour-line"></i> <span>List Program</span>
                    </a>
                </li>
 <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('detail-program')); ?>">
                        <i class="ri-honour-line"></i> <span>Detail Program</span>
                    </a>
                </li>
 <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('status-pembayaran')); ?>">
                        <i class="ri-honour-line"></i> <span>Status Pembayaran</span>
                    </a>
                </li>
 <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('bukti-pembayaran')); ?>">
                        <i class="ri-honour-line"></i> <span>Bukti Pembayaran</span>
                    </a>
                </li>
 <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('sertifikat')); ?>">
                        <i class="ri-honour-line"></i> <span>Sertifikat</span>
                    </a>
                </li>
 <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('template-create')); ?>">
